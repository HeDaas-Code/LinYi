...
输出：
  {project_root}/src/webui/public/assets/tilemaps/{space_id}/tileset.png
  {project_root}/src/webui/public/assets/tilemaps/{space_id}/tilemap.json
...
# 相对于本文件定位项目根目录，避免硬编码绝对路径。
_ROOT = Path(__file__).resolve().parent.parent / "src" / "webui" / "public" / "assets" / "tilemaps"
ROOT = str(_ROOT)
TILE_SIZE = 16
TILED_VERSION = "1.9"
